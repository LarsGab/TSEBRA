class Node_features:
    def __init__(self, tx, evi, anno_pref):
        ...
        # self.feature_vector[2] : sum os multiplicities of intron evidence for tx
        # self.feature_vector[3] : sum os multiplicities of start/stop codon evidence for tx
